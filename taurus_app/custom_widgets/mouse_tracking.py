...
class MouseTracker(TaurusWidget):
    ...
    def __init__(self, parent=None, shape_config = draw_components):
        ...
        self.setModel('motor/omsvme58_motor_eh/4/Position', key = 'ampli')
        self.setModel('ioregister/sis3610in_eh/1/SimulationMode', key = 'ior1')
        self.setModel('ioregister/sis3610in_eh/2/SimulationMode', key = 'ior2')
        self.setModel('ioregister/sis3610in_eh/3/SimulationMode', key = 'ior3')
        self.setModel('motor/omsvme58_motor_eh/1/Position', key = 'offset')
        self.setModel('motor/omsvme58_motor_eh/2/Position', key = 'gx')
        self.setModel('motor/omsvme58_motor_eh/3/Position', key = 'gy')
